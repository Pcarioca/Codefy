...
document.addEventListener('DOMContentLoaded', function () {
 ...
 document.getElementById("buton").onclick = add;
    ...
    document.getElementById("buton").addEventListener("click", add());
...
document.getElementById("vanish").addEventListener("click",vanish());
document.getElementById("button").addEventListener("click",storage());
document.getElementById("buton").addEventListener("click",add());
